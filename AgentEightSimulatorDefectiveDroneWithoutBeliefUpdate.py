...
from AgentEightDefectiveDroneWithoutBeliefUpdate import *
import csv
from time import time
from datetime import datetime
def simulate_agent_eight_dd_without_belief_update():
    #=========== Log file =======================
    start = time()
    filename_txt="Results/AgentEightDefectiveDroneWithoutBeliefUpdate.txt"
    filename_csv="Results/AgentEightDefectiveDroneWithoutBeliefUpdate.csv"
    ...
    for sim in range(1,n_sim+1):
        ...
        for trial in range(1,n_trials+1):
            ...
            agent_eight=AgentEightDefectiveDroneWithoutBeliefUpdate(n_nodes, G, prey, predator)
