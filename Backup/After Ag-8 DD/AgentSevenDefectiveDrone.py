...
class AgentSevenDefectiveDrone:
...
#Used for testing. Not part of the main flow. AgentSevenDefectiveDrone simulator will call AgentSevenDefectiveDrone
if __name__=="__main__":
    ...
    agent_seven=AgentSevenDefectiveDrone(n_nodes, G, prey, predator)
