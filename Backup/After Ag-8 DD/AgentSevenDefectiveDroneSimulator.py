...
from AgentSevenDefectiveDrone import *
import csv
from time import time
from datetime import datetime
def simulate_agent_seven_defective_drone():
    #=========== Log file =======================
    start = time()
    filename_txt="Results/AgentSevenDefectiveDrone.txt"
    filename_csv="Results/AgentSevenDefectiveDrone.csv"
