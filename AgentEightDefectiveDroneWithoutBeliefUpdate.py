...
class AgentEightDefectiveDroneWithoutBeliefUpdate:
...
#Used for testing. Not part of the main flow. AgentEightDefectiveDroneWithoutBeliefUpdate simulator will call AgentEightDefectiveDroneWithoutBeliefUpdate
if __name__=="__main__":
    ...
    agent_seven=AgentEightDefectiveDroneWithoutBeliefUpdate(n_nodes, G, prey, predator)
