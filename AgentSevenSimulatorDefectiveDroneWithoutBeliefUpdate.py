...
from AgentSevenDefectiveDroneWithoutBeliefUpdate import *
import csv
from time import time
from datetime import datetime
def simulate_agent_seven_dd_without_belief_update():
    #=========== Log file =======================
    start = time()
    filename_txt="Results/AgentSevenDefectiveDroneWithoutBeliefUpdate.txt"
    filename_csv="Results/AgentSevenDefectiveDroneWithoutBeliefUpdate.csv"
