    ...
    for sim in range(1,n_sim+1):
        ...
        for trial in range(1,n_trials+1):
            ...
            while(steps<=max_steps):
                ...
                d_predator=len(get_bfs_path(agent_six.G, agent_six.position, survey_node)[1])  #Distance from predator
                ...
                if d_predator<pred_dist_threshold:
                    ...
                    agent_six.update_belief(survey_node, prey.position)
                else:
                    if agent_six.survey:
                        agent_six.update_belief(survey_node, prey.position)
                        # print("Survey done")
                        agent_six.survey=False
                        ...
                        #Updating belief based on current agent position
                        agent_six.update_belief(survey_node, prey.position)
                        agent_six.survey=True #So that suvery is done 
