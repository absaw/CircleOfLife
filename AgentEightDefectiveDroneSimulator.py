...
from AgentEightDefectiveDrone import *
import csv
from time import time
from datetime import datetime
def simulate_agent_eight_defective_drone():
    #=========== Log file =======================
    start = time()
    filename_txt="Results/AgentEightDefectiveDrone.txt"
    filename_csv="Results/AgentEightDefectiveDrone.csv"
    ...
    for sim in range(1,n_sim+1):
        ...
        for trial in range(1,n_trials+1):
            ...
            agent_eight=AgentEightDefectiveDrone(n_nodes, G, prey, predator)
